...
eval_result_RMSE <- function(true_value, predicted_value, df){
...
RMSE_stepwise_regression <- eval_result_RMSE(imdb_rating_real_values_test, imdb_rating_predicted_values_stepwise, test_20_set)
...
RMSE_lasso <- eval_result_RMSE(imdb_rating_dep_test, imdb_rating_predicted_values_lasso, test_20_set)
